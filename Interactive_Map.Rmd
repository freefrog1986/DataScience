...
https://freefrog1986.github.io/DataScience/Interactive_Map.html

### Create the dataset
 In this script, we care about the house price of china's capital city beijing and the surranding citys, all those price data come from this site: http://www.creprice.cn/naprice/funation.html
```{r}
library(leaflet)
...
### Plot the house price in the Interactiv map using leaflet.
```{r}
df %>%
        leaflet() %>%
        addTiles() %>%
        addCircles(radius=df$price,weight=3)
```
